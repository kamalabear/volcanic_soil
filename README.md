...
- None required for the core soil nodes and farming behavior.

## Optional Integrations

- **moreblocks:** Enables the compressed cobble cooking recipe.
- **Lava Crucible:** If installed, crucibles can also produce volcanic soil from stone.

---

## Documentation

- [User's Guide](USAGE.md) — how to obtain volcanic soil, properties, uses, and recipes
- [Developer's Guide](DEVELOPMENT.md) — node definition, recipe system, integration with other mods
